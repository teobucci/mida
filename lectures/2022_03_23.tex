...
% Text Node
\draw (95,93.4) node [anchor=north west][inner sep=0.75pt]    {$\Mc(\theta)$};
% Text Node
...
% Text Node
\draw (378,87.34) node [anchor=north west][inner sep=0.75pt]    {$\hat{\Mc}(\theta)$};
% Text Node
...
% Text Node
\draw (173,227.34) node [anchor=north west][inner sep=0.75pt]    {$\hat{\Mc}(\theta)$};
% Text Node
...
\qquad \text{Least Squres formula}
\end{equation*}
