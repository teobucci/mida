...
$v(t,s)=\alpha (s),\forall t$ where $\alpha (s)\sim \mathcal{N}(1,3)$ (Gaussian random variable with mean = 1 and variance = 3).
...
$v(t, s)=t \cdot \alpha(s)-t$, where $\alpha(s) \sim \mathcal{N}(1,3)$.
\begin{itemize}
