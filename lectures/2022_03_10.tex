...
Condition 4a assure that $W(z)$ is asymptotically stable so that $y(t)$ is well defined, while 4b removes any ambiguity as due to the process described in Case 4.
...
\textbf{Abstraction.} We suppose to have the all the observations from $-\infty$ up to $t$ (infinite sequence of observations).
