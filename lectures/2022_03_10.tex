...
\begin{theorem}[Spectral Factorization]
    ...
    \begin{enumerate}
		...
		\item the poles and the zeroes of $W(z)$ are such that $|z|\geq 1$.
    \end{enumerate}
\end{theorem}
...
The first part of Condition 4 assure that $W(z)$ is asymptotically stable\todo{in realtà no, chiede solo $|z|\le 1$, mentre per l'a.s. serve $|z|<1$.} so that $y(t)$ is well defined, while the second part removes any ambiguity as due to the process described in Case 4.
